...
def main() -> None:
    ...
    require(cmake, 'OBS_BGS_DEVELOPMENT_VERSION "243"', "CMake development version")
    require(build, 'BGL_DEVELOPMENT_VERSION "243"', "runtime development version")
    require(schema, "kCurrentDevelopmentVersion = 243", "serialization version")
