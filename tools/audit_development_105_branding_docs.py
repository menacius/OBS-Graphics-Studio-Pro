...
check(
    ...
    "project(broadcast-graphics-live VERSION 0.8.10)" in cmake
    ...
    and '#define PLUGIN_VERSION "0.8.10-alpha"' in build_info
    and '#define PLUGIN_VERSION "0.8.10-alpha"' in plugin_main
    and "v0.8.10-alpha" in readme
